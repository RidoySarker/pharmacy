<form id="edit_form" enctype="multipart/form-data" method="post">
    <div class="modal-body">
      ...
      <div class="form-group">
        ...
        <input type="text" class="form-control" placeholder="Enter Medicine Code" id="medicine_code" name="medicine_code" value="{{ $medicine->medicine_code }}">
      </div>
      <div class="form-group">
        <label>Medicine Name</label>
        <input type="text" class="form-control" placeholder="Enter Medicine Name" id="medicine_name" name="medicine_name" value="{{ $medicine->medicine_name }}">
      </div>
      <div class="form-group">
